...
Na primeira capacidade do projeto, perguntar via `AskUserQuestion` (greenfield vs org-existente) quando não for óbvio pelo layout do repo, e registrar a decisão no `build-report.md`:
